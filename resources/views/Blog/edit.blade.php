					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="{{route('blog.edit',$blog->id)}}">Edit Blog</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
                ...
                <form action="{{route('blog.update', $blog->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                      ...
                      <textarea name="blogcontent" id="blogcontent" class="tinymce" cols="30" rows="10">
                          {{$blog->isi_blog}}
                      </textarea>
                      @error('blogcontent')
                                <span class="text-danger" role="alert">
