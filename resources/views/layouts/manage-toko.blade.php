					...
					<div class="row">
						<div class="col-lg-3">
                            <div class="all-category">
								<h3 class="cat-heading">Dasbor Toko</h3>
                            </div>
						</div>
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
													<li class="mr-0 @yield('produk')"><a href="{{route('toko.manage.produk')}}">Produk Anda</a></li>
                                                    <li class="mr-0 @yield('blog')"><a href="{{route('toko.manage.blog')}}">BlogTani</a></li>
													<li class="mr-0 @yield('pemesanan')"><a href="{{route('toko.manage.pesanan')}}">Pesanan Masuk</a></li>
												</ul>
										</div>
									</div>
								</nav>
